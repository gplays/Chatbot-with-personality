...
def process_encoding_input(target_data, vocab_to_int, batch_size):
    ...
    #  Auto corextion from old version TO CHECK
    dec_input = tf.concat(
        axis=[tf.fill([batch_size, 1], vocab_to_int['<GO>']), ending],
        values=1)
    return dec_input
...
def decoding_layer_train(encoder_state, decoder_cell, dec_embed_input, sequence_length, decoding_scope,
    ...
    ## from https://github.com/tensorflow/nmt#background-on-the-attention-mechanism
    ...
    # train_pred_drop = tf.contrib.seq2seq.D(train_pred, keep_prob)
...
def decoding_layer(dec_embed_input, dec_embeddings, encoder_state, vocab_size, sequence_length, rnn_size,
    ...
    with tf.variable_scope("decoding") as decoding_scope:
        ...
        ## all will share params, try [ [drop] for _ in range (num_layers)
        ## Change from 1.2
